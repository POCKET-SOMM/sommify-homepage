...
function App() {
  ...
  return (
    <div id='content'>
      ...
      />
      <div className='w-full text-center mt-[30vh] mb-10'>
        <h1
        // style={{
        //   lineHeight: 1.25,
        //   marginBottom: '1.4em',
        ...
        >
          {/* We built an
          <br /> */}
          AI sommelier for scalable wine sales.
        </h1>
      </div>
      ...
      <div className='flex my-64'>
        <div className='flex flex-col items-center justify-center flex-1 gap-5 px-24'>
          {[
            'Give us your wine portfolio',
            'Receive your agent domain',
            'Input customer data',
            'Generate wine offers',
            'Share with customers',
          ].map((step, i) => (
            <div
              key={i}
              className='flex items-center gap-4 mb-6 border border-slate-200 rounded-lg p-6 w-[300px] cursor-pointer shadow-sm'
              style={{
                margin: i % 2 !== 0 ? '0 80px 0 0' : '0 0 0 80px',
              }}
            >
        ...
        <div className='flex flex-col items-start justify-center flex-1'>
          <h2>Hassle-free integration</h2>
          <h3 className='mb-12'>
            Lead the future of wine with us and our partners
          </h3>

          <div className='flex gap-2'>
            <span className='flex items-center gap-2 bg-slate-800 text-white font-[450] px-4 py-2 text-sm rounded-full cursor-pointer hover:bg-slate-900 transition-colors duration-200'>
              Go to docs
              <MdArrowOutward className='text-lg' />
            </span>

            <span className='flex items-center gap-2 border border-slate-800 text-slate-800 font-[450] px-4 py-2 text-sm rounded-full cursor-pointer hover:bg-slate-100 transition-colors duration-200'>
              Talk to a founder
              <MdArrowOutward className='text-lg' />
            </span>
          </div>
      ...
      {/* <div className='my-64 flex'>
        <div className='flex-1 flex flex-col items-start justify-center px-24'>
          <h2>Trusted by the best</h2>
          <h3>Join our partners and something</h3>
        </div>
      ...
      <div className='flex flex-col items-center justify-center my-64'>
        ...
        <div className='flex gap-8'>
          <div className='w-[400px] h-[500px] border border-slate-200 shadow-sm rounded-xl flex flex-col items-center justify-start p-10'>
            <span className='text-6xl font-[600] mb-1'>
              <span className='font-light'>€</span>
              <span className='italic'>350</span>
            </span>
            <span className='font-[400] mb-10'>monthly per seat</span>
            <ul className='list-disc list-inside text-left mb-10'>
              <li>Unlimited wine offers</li>
              <li>Unlimited customer interactions</li>
