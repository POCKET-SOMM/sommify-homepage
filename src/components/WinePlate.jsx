...
const wineOrigin = (wine) => {
  ...
  return (
    <span style={{ fontSize: '12px' }}>
      <CircleFlag
        countryCode={country_code[wine['country']].toLowerCase()}
        height='15'
          ...
          >
            <div>
              <span style={{ display: 'block' }}>
                €{this.props.wine['price'].toFixed(2)}
              </span>
            </div>
          </div>
          <div
            onClick={(e) => {
              this.setToggled(!this.state.toggled);
            }}
            id='wine-basics'
            style={{
              height: '90px',
            ...
            >
              ...
              >
                <b
                  className='winelink'
                  onClick={(e) => {
                    window.open(this.props.wine['link'], '_blank');
                  }}
                >
                  {truncate(this.props.wine.name.replaceAll('-', ' '), 100)}
                </b>
              </span>
          ...
          <Fade in={this.state.toggled}>
            <div style={{ display: this.state.toggled ? '' : 'none' }}>
              <div
                ...
                style={{
                  display:
                    this.props.wine['variety'].length < 3 ? 'none' : 'flex',
                  width: '100%',
              ...
              >
                ...
                <div style={{ height: '100%', width: '80%' }}>
                  {this.props.wine['variety'].length > 3
                    ? stringToList(this.props.wine['variety']).map((v) => (
                        <div
                          key={`${this.props.wine['PRODUCT NUMBER']}_${v}_variety`}
                          style={{
              ...
              <div
                id='wine-quals'
                style={{ width: '70%', float: 'left', padding: '15px' }}
              >
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {this.props.wine[qual] <= 1 ? (
                            <b>{qualitiesB[qual].toUpperCase()}</b>
                          ) : (
                            qualitiesB[qual].toUpperCase()
                          )}
                        </span>
                      </div>
                      <div
                      ...
                      >
                        ...
                        >
                          {this.props.wine[qual] >= 3 ? (
                            <b>{qualities[qual].toUpperCase()}</b>
                          ) : (
                            qualities[qual].toUpperCase()
                          )}
                        </span>
                      </div>
                    </div>
