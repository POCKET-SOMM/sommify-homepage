...
/* ---- Classic loupe mark (mirrors public/lupa.svg) — on the back burner. To
   restore: swap <SwirlMark> for <LupaMark size={Math.round(size * 0.95)} /> in
   Wordmark above (gap 7 looked better with the loupe) and uncomment this block.
