...
/* ---- Swirl mark — on the back burner. To restore: re-add `import { useId }
   from "react";` at the top, swap <LupaMark> for <SwirlMark size={size} /> in
   Wordmark above (it also wants className="sommify-wordmark" on the wrapper and
   gap 4 for the hover animation), and uncomment this block.
